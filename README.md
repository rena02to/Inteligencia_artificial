...
<div align="center">
  OBS.: Os três primeiros algoritmos recebem os dados (estacao de inicio/fim, por exemplo) direto no no código, portanto, se for necessário alterar esse formato para receber inputs será necessário atualizar o código, ou atualizar as variaveis no código para que elas busquem as solucoes a partir de outros dados.
</div>
